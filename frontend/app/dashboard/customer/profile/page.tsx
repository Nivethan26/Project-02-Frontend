...
import { Mail, Phone, MapPin, User as UserIcon, BadgeCheck, CalendarCheck, ShieldCheck, Edit, KeyRound, Trash2, Lock, AlertTriangle } from 'lucide-react';
...
// Add helper for animated border
...
export default function CustomerProfilePage() {
  ...
  function handleDeleteOpen() { setShowDelete(true); setShowSettings(false); setDeleteError(null); }
  ...
  return (
    <ProtectedRoute role="customer">
      <div className="flex min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-200 relative overflow-hidden">
        ...
        <div className="hidden md:block"><Sidebar role="customer" /></div>
        <main className="flex-1 md:ml-64 p-0 sm:p-4 flex flex-col items-center justify-start relative z-10">
          ...
          <div className="w-full flex justify-center mt-20 sm:mt-24">
            <div className="w-full max-w-lg sm:max-w-2xl md:max-w-3xl bg-white/70 backdrop-blur-2xl rounded-3xl shadow-2xl border border-blue-100 p-4 sm:p-10 md:p-16 md:py-20 animate-fadeInUp relative">
              <h1 className="text-5xl font-bold text-blue-900 mb-3 text-center tracking-tight font-sans">Customer Profile</h1>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between p-4 rounded-lg border hover:shadow transition cursor-pointer bg-white/80 backdrop-blur-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-semibold text-gray-800">Delete Account</span>
                    </div>
                    <button onClick={handleDeleteOpen} className="text-red-600 font-semibold">Delete</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          {showDelete && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-blue-500/70 animate-fadeIn">
              <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative animate-scaleIn">
                <button onClick={handleDeleteClose} className="absolute top-3 right-3 text-gray-400 hover:text-gray-700 text-2xl">&times;</button>
                <div className="flex items-center gap-2 mb-4">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex-1 bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg font-semibold transition disabled:opacity-60"
                    disabled={deleting}
                  >
