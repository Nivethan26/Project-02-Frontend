  ...
  return (
    <section className="bg-gray-50 py-12 sm:py-16">
      <div className="max-w-6xl mx-auto px-2 sm:px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-4 sm:mb-6 gap-2 sm:gap-4">
        ...
        <p className="text-gray-600 max-w-4xl mb-8 sm:mb-12 md:ml-32 text-center md:text-left">
          More than feedback, these are reminders of why we do what we do. Thank you for letting us be part of your health journey!
        </p>

        {/* Testimonial Card */}
        <div className="bg-white shadow-xl rounded-xl max-w-5xl mx-auto p-4 sm:p-8 relative">
